...
def show_webcam(mirror=False):
    global cam
    try:
        cam = cv2.VideoCapture(1)       #idk why this is flagged
                                        #its fine. ignore this flag

    except NameError:
        print 'ERROR with camera, it may be busy with another process, \
        blocked by a anti-virus program, or not set as default'
    ...
    while True:
        ...
        if mirror:
            ...
            if cv2.waitKey(1) == ord('a'):
                ...
                f = '/home/tyler/PycharmProjects/t2e2/FIles/edges-file' + 'edge' + str(x) + str(i) + '.png'
                ff = '/home/tyler/PycharmProjects/t2e2/FIles/edges-file' + 'rgimg' + str(x) + str(i) + '.png'
                fff = '/home/tyler/PycharmProjects/t2e2/FIles/edges-file/' + 'rimg' + str(x) + str(i) + '.png'
...
def main():
    ...
    t2e.filez('tree.txt', '/home/tyler/PycharmProjects/t2exe/tree.exe')  //fix me here 
